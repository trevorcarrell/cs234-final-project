        ...
        for data in tqdm(train_loader):
            ...
            for e, episode in enumerate(episodes):
                ...
                for s, sub_episode in enumerate(episode):
                    ...
                    # TODO: How to incorporate advantage function
                ...
                all_feedbacks[user_id] = torch.cat(user_feedbacks, dim=0)
                # print(user_mask_probs)
                old_masked_probs[user_id] = torch.stack(user_mask_probs, dim=0)
                # print(old_masked_probs[user_id].shape)
                # print(all_feedbacks[user_id].shape)
